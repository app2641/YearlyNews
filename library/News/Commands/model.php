...
class model extends Base\AbstractCommand
{
    ...
    public function execute (Array $params)
    {
        try {
            ...
            $model = ROOT_PATH.'/library/News/Model/'.$this->model_name.'Model.php';
            ...
            $model = ROOT_PATH.'/library/News/Model/Column/'.$this->model_name.'Column.php';
            ...
            $model = ROOT_PATH.'/library/News/Model/Query/'.$this->model_name.'Query.php';
    ...
    {
        $data = str_replace('News', $this->app_name, $data);
